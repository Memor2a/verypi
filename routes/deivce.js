...
//    var paramUserName = req.body.title || req.query.title;
//    var paramDeviceType = req.body.contents || req.query.contents;
//    var paramDeviceIp = req.body.writer || req.query.writer;u
